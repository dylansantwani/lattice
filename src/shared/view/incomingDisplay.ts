...
const REDUNDANT_LEAD_INS: RegExp[] = [
  // runManager.formatAgentCompletion, success variant (both the current and the older wording)
...
const MODEL_INSTRUCTIONS: RegExp[] = [
  // runManager.NOTICE_GUIDANCE, after a job's "Its output is below." (current wording)
  / Its output is below\. This is an automatic notice from your own background work, not a message from the user\. Use it if it matters for what the user asked; if it changes nothing they need to hear, reply with exactly NO_REPLY\./u,
